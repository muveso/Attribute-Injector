...
namespace AttributeInjector.Editor.Type_Extensions
{
    public static class TypeDefinitionExtensions
    {
        ...
        /// Finds a method from a type based on it's name and argument count
        /// </summary>
        public static FieldDefinition GetField(this TypeDefinition instance, string name)
        {
            for (int i = 0; i < instance.Fields.Count; i++)
            {
                FieldDefinition methodDef = instance.Fields[i];
